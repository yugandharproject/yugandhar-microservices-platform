...
truncate table ref_language_code;
truncate table ref_currency;
truncate table ref_country_iso;
truncate table config_txn_registry;
truncate table config_language_code;
truncate table config_errorcode_registry;
truncate table config_app_properties;
truncate table auth_user_role_assoc;
truncate table auth_user_registry;
truncate table auth_userrole_accesscontrol;
truncate table auth_roles_registry;
-- --------------------------------------------------------
-- Host:                         127.0.0.1
...
-- Dumping data for table yug_msp.ref_currency: ~0 rows (approximately)
...
-- Dumping data for table yug_msp.ref_language_code: ~0 rows (approximately)
...
truncate table al_ref_language_code;
truncate table al_ref_currency;
truncate table al_ref_country_iso;
truncate table al_config_txn_registry;
truncate table al_config_language_code;
truncate table al_config_errorcode_registry;
truncate table al_config_app_properties;
truncate table al_auth_user_role_assoc;
truncate table al_auth_user_registry;
truncate table al_auth_userrole_accesscontrol;
truncate table al_auth_roles_registry;

drop sequence yug_msp.YUG_ERRORCODE_SEQ;
drop sequence yug_msp.YUG_REGISTRY_SEQ;
