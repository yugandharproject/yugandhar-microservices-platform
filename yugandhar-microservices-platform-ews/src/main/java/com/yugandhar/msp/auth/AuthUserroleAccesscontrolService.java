...
@Service("com.yugandhar.msp.auth.AuthUserroleAccesscontrolService")
...
*@throws YugandharCommonException yugandhar common exception if AuthUserroleAccesscontrolDO object is not present in the request or other mandatory attributes not present
	*
	*/
	@Transactional
...
*@throws YugandharCommonException yugandhar common exception if AuthUserroleAccesscontrolDO object is not present in the request or mandatory attributes primary key is not present
	*/
	@Transactional
...
*@throws YugandharCommonException yugandhar common exception if AuthUserroleAccesscontrolDO object is not present in the request or mandatory attributes primary key is not present
	...
	*@param  txnTransferObj  Transfer Object TxnTransferObj instance
	*@return  txnTransferObj Returns the Transfer Object TxnTransferObj instance populated with database instance 
*@throws YugandharCommonException yugandhar common exception if AuthUserroleAccesscontrolDO object is not present in the request or mandatory attributes business key is not present
	*/
	@Transactional(readOnly = true)
