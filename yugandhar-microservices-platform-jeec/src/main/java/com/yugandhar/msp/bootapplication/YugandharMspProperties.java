...
@PropertySource("classpath:yugandhar-msp.properties")
public class YugandharMspProperties {

	@Value("${yugandhar.msp.datasource.url:#{null}}")
	private String datasourceurl;

	@Value("${yugandhar.msp.datasource.username.plaintext:#{null}}")
	private String datasourceUsernamePlaintext;

	@Value("${yugandhar.msp.datasource.password.plaintext:#{null}}")
	private String datasourcePasswordPlaintext;

	@Value("${yugandhar.msp.datasource.username.encrypted:#{null}}")
	private String datasourceUsernameEncripted;

	@Value("${yugandhar.msp.datasource.password.encrypted:#{null}}")
	private String datasourcePasswordEncripted;

	@Value("${yugandhar.msp.datasource.driver-class-name:#{null}}")
	private String datasourceDriveClassName;

	@Value("${yugandhar.msp.datasource.xa.data-source-class-name:#{null}}")
