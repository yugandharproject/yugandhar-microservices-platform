...
// Step 4. Make an entry in make entry in YugandharMsplatformApplication
...
###STEP 1###
// Add below block of code in xpath <service><jsr107:defaults> of the /yugandhar-microservices-platform/src/main/resources/ehcache.xml
//----------------------------------------------------
	<jsr107:cache name="${pojo.getDeclarationName().toUpperCase()}_BUSKEY" template="heap-cache" />

	
###STEP 2###
// Add below block of code in xpath <Config> of the /yugandhar-microservices-platform/src/main/resources/ehcache.xml
//----------------------------------------------------
